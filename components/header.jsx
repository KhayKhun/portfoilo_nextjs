...
const HeaderComponent = () => {
  return (
    <header className='fixed top-0 w-screen bg-opacity-[0.5] z-[1000] flex px-[40px] py-[10px] justify-between bg-teal-100 shadow-sm shadow-teal-300'>
        <ul className='flex text-[16px] gap-[15px] font-bold'>
            <h1 className='text-black hover:cursor-default'>&lt;<span className='text-green-500'> simple </span>/&gt;</h1>
