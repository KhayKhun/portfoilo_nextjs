...
const HeaderComponent = () => {
  return (
    <header className='fixed top-0 w-screen bg-opacity-[0.5] z-[1000] flex px-[40px] py-[10px] lg:py-[20px] justify-between bg-teal-100 shadow-sm shadow-teal-300 text-sm sm:text-md lg:text-lg'>
