...
const WelcomeComponent = () => {
  return (
    <section className="flex justify-evenly py-[100px] welcome text-3xl font-bold h-screen">
      <div className='flex flex-col justify-between py-[60px]'>
        <div>
            <h1 className=''>
                Hi There! I'm <span className={`${Titillium.className} text-4xl text-blue-500`}>Khay Khun</span>.</h1>
      ...
      <div className='w-[280px] h-[280px] overflow-hidden me bg-gradient-to-b from-blue-300 to-teal-200'>
